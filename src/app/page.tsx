    ...
    <h1 className="text-2xl font-semibold text-white">NutriSnap</h1>
        ...
        <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen">
          ...
          <div className="mt-12 bg-white/10 backdrop-blur rounded-2xl p-6 max-w-md">
            ...
            <br><br>🎵 Made by <a href="https://github.com/workhardbekind/nutrisnap-web">workhardbekind</a>  💨<br><br><br>><a href="https://ko-fi.com/districtdave">Buy Dave a Coffee</a></p>
          </div>
        </div>
      </main>
    );
